...
REM
REM Generated by Vivado on Mon Jan 19 10:00:46 +0300 2026
...
echo "xvhdl --incr --relax -prj lap_timer_tb_vhdl.prj"
call xvhdl  --incr --relax -prj lap_timer_tb_vhdl.prj -log xvhdl.log
