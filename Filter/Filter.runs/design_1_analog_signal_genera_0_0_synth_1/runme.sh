...
HD_PWD='C:/Vivado_Project/Filter/Filter.runs/design_1_analog_signal_genera_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_analog_signal_genera_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_analog_signal_genera_0_0.tcl
