...
HD_PWD='C:/Vivado_Project/Filter/Filter.runs/design_1_axis_config_module_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_config_module_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_config_module_0_1.tcl
