...
HD_PWD='d:/vivado_projects/mam_project/mam_project.tmp/lvds_axis_v1_0_project/lvds_axis_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lvds_axis_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lvds_axis_v1_0.tcl
