...
HD_PWD='C:/Vivado_Project/MAM_Project_Basys3/MAM_Project_Basys3.runs/design_1_lvds2axis_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_lvds2axis_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_lvds2axis_0_0.tcl
