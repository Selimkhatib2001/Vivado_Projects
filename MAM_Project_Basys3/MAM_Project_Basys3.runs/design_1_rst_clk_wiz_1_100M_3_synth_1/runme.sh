...
HD_PWD='C:/Vivado_Project/MAM_Project_Basys3/MAM_Project_Basys3.runs/design_1_rst_clk_wiz_1_100M_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_1_100M_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_1_100M_3.tcl
