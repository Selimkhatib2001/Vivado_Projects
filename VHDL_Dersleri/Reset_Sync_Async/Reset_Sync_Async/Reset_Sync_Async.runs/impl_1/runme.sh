...
HD_PWD='C:/Vivado_Project/VHDL_Dersleri/Reset_Sync_Async/Reset_Sync_Async/Reset_Sync_Async.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reset_1.tcl -notrace
