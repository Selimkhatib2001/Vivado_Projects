...
HD_PWD='C:/Vivado_Project/VHDL_Dersleri/Reset_Sync_Async/Reset_Sync_Async/Reset_Sync_Async.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reset_1.tcl
