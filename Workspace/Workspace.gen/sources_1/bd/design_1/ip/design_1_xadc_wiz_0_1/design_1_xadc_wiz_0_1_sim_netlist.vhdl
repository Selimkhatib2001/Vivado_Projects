...
--               c:/Vivado_Project/Workspace/Workspace.gen/sources_1/bd/design_1/ip/design_1_xadc_wiz_0_1/design_1_xadc_wiz_0_1_sim_netlist.vhdl
...
entity design_1_xadc_wiz_0_1_drp_to_axi4stream is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_xadc_wiz_0_1_drp_to_axi4stream : entity is "drp_to_axi4stream";
end design_1_xadc_wiz_0_1_drp_to_axi4stream;

architecture STRUCTURE of design_1_xadc_wiz_0_1_drp_to_axi4stream is
...
end design_1_xadc_wiz_0_1_xadc_core_drp;

architecture STRUCTURE of design_1_xadc_wiz_0_1_xadc_core_drp is
...
drp_to_axi4stream_inst: entity work.design_1_xadc_wiz_0_1_drp_to_axi4stream
     port map (
      AR(0) => m_axis_reset,
      CHANNEL(4 downto 0) => \^channel_out\(4 downto 0),
      DO(15 downto 0) => do_C(15 downto 0),
...
end design_1_xadc_wiz_0_1_axi_xadc;

architecture STRUCTURE of design_1_xadc_wiz_0_1_axi_xadc is
...
begin
  ...
  alarm_out(1) <= \<const0>\;
  alarm_out(0) <= \<const0>\;
AXI_XADC_CORE_I: entity work.design_1_xadc_wiz_0_1_xadc_core_drp
     port map (
...
entity design_1_xadc_wiz_0_1 is
  ...
  attribute NotValidForBitStream of design_1_xadc_wiz_0_1 : entity is true;
end design_1_xadc_wiz_0_1;

architecture STRUCTURE of design_1_xadc_wiz_0_1 is
  signal NLW_U0_alarm_out_UNCONNECTED : STD_LOGIC_VECTOR ( 6 downto 0 );
begin
U0: entity work.design_1_xadc_wiz_0_1_axi_xadc
     port map (
