...
##Pmod Header JC
##Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {generator_lvds_clk_p_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {generator_lvds_clk_p_0}]
##Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {JC[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JC[1]}]
##Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {generator_lvds_clk_p_0}]
#set_property IOSTANDARD TMDS_33 [get_ports {generator_lvds_clk_p_0}]
##Sch name = JC4
#set_property PACKAGE_PIN P18 [get_ports {JC[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JC[3]}]
##Sch name = JC7
#set_property PACKAGE_PIN L17 [get_ports {generator_lvds_clk_p_0}]
#set_property IOSTANDARD TMDS_33 [get_ports {generator_lvds_clk_p_0}]
##Sch name = JC8
...
set_property IOSTANDARD TMDS_33 [get_ports valid_p_i_0]
##Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports Vaux7_0_v_p]
set_property IOSTANDARD LVCMOS33 [get_ports Vaux7_0_v_p]
##Sch name = XA4_P
#set_property PACKAGE_PIN N2 [get_ports Vaux15_0_v_p]
...
#Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports {Vaux15_0_v_n}]
