...
HD_PWD='D:/Vivado_Projects/ip_repo/arithmetic_ip/edit_arithmetic_ip_v1_0.runs/design_1_div_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_div_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_div_gen_0_0.tcl
