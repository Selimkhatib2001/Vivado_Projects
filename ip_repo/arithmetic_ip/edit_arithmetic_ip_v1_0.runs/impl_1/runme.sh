...
HD_PWD='D:/Vivado_Projects/ip_repo/arithmetic_ip/edit_arithmetic_ip_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arithmetic_ip_v1_0.tcl -notrace
