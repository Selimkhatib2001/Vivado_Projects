...
HD_PWD='D:/Vivado_Projects/ip_repo/arithmetic_ip/edit_arithmetic_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arithmetic_ip_v1_0.tcl
