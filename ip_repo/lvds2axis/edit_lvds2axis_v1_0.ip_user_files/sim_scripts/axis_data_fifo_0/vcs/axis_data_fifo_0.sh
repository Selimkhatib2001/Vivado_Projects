...
design_libs=(xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_14 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axis_data_fifo_v2_0_14 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
