...
HD_PWD='C:/Vivado_Project/ip_repo/lvds_axis_ip/edit_lvds_axis_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lvds_axis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lvds_axis.tcl
